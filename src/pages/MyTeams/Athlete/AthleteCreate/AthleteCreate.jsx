...
const AthleteCreate = () => {
  ...
  useEffect(() => {
    if (
      ...
      school !== "" ||
      university !== "" ||
      currentSportInstitution !== "" ||
      trainer !== "" ||
      trainerContacts !== "" ||
      entryDate ||
      Object.keys(establishmentsData).length > 0 ||
      medicalData.allergies !== "" ||
      medicalData.diseases !== "" ||
      Object.keys(medicalInformation).length > 0 ||
      Object.keys(parentsInformation).length > 0
    ) {
      setHasChanges(true);
    } else {
      setHasChanges(false);
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(createAthlete(formData))
      ...
      .then((athlete) => {
        ...
        setUniversity("");
        setSchool("");
        setCurrentSportInstitution("");
        setTrainer("");
        setTrainerContacts("");
        setEntryDate("");
        setEstablishmentsData({});
        setMedicalData({ allergies: "", diseases: "" });
        setMedicalInformation({});
        setParentsInformation({});
