import{r as o,d as r,j as t,a as gt,u as ft,f as ot,L as bt,i as Dt,R as Re,m as Bt,c as Et,y as te,T as Mt}from"./index-cec7cca9.js";import{g as nt,a as Lt,u as Rt,b as Nt,D as zt,C as ke}from"./CustomDatePicker-97eda630.js";import{p as ve}from"./PlaceholderProfile-3c1b0d36.js";import{P as Tt}from"./PlaceholderTeam-7b26a08e.js";import{S as Ne}from"./DeleteIcon-3f31b818.js";import{a as Pt,S as Ft,u as Ot,N as _t}from"./minus-e2bf1d06.js";const wt=e=>o.createElement("svg",{viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},o.createElement("path",{d:"M6 9L12 15L18 9",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),Wt=r.div`
...
`,Gr=(e,a,g=1)=>{let l=[];for(let v=e;v<=a;v+=g)l.push(v);return l},Le=({value:e,onChange:a,placeholder:g="Оберіть дату",hasError:l=!1,minDate:v,maxDate:x})=>{const $=h=>{if(!h)return null;try{const u=new Date(h);return isNaN(u.getTime())?null:u}catch{return null}},[f,m]=o.useState(()=>$(e));o.useEffect(()=>{m($(e))},[e]);const b=Gr(1900,nt(new Date)),p=["Січень","Лютий","Березень","Квітень","Травень","Червень","Липень","Серпень","Вересень","Жовтень","Листопад","Грудень"],c=h=>{if(m(h),h){const u=h.getFullYear(),j=String(h.getMonth()+1).padStart(2,"0"),s=String(h.getDate()).padStart(2,"0");a(`${u}-${j}-${s}`)}else a("")};let i=$(v);return i&&(i=Lt(i,0)),t.jsx(Ir,{children:t.jsx(vr,{selected:f,onChange:c,dateFormat:"dd.MM.yyyy",placeholderText:g,locale:Rt,$error:l,minDate:i,maxDate:x?$(x):void 0,renderCustomHeader:({date:h,changeYear:u,changeMonth:j})=>t.jsxs(jr,{children:[t.jsx(yr,{value:nt(h),onChange:s=>{u(parseInt(s.target.value))},children:b.map(s=>t.jsx("option",{value:s,children:s},s))}),t.jsx(Cr,{value:p[Nt(h)],onChange:s=>{j(p.indexOf(s.target.value))},children:p.map((s,n)=>t.jsx("option",{value:s,children:s},n))})]})})})},Sr=r(Ne)`
