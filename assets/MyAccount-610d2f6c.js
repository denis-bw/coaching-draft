import{u as _,a as V,r as i,N as K,d as o,j as t,b as X,c as Z,e as q,L as J,p as O,f as Q,y as G}from"./index-fb682d94.js";import{S as ee,C as te}from"./CustomDatePicker-026dd509.js";function oe(e){const n=_(),p=V(),{navigator:l}=i.useContext(K),[g,d]=i.useState(!1),[u,w]=i.useState(null),[x,C]=i.useState(!1),h=i.useCallback(m=>{const $="/coaching-draft";let c=m;return c.startsWith($)&&(c=c.substring($.length)),c=c.replace(/\/+/g,"/"),c=c.replace(/\/$/,""),c},[]),v=i.useCallback((m,$)=>{const c=h(m),f=h($);return c===f},[h]),y=i.useCallback(()=>{d(!1),w(null),C(!1)},[]),E=i.useCallback(()=>{if(u){C(!0),d(!1);let m;typeof u=="string"?m=h(u):m=h(u.pathname)+(u.search||""),setTimeout(()=>{n(m),w(null),C(!1)},0)}},[u,n,h]);return i.useEffect(()=>{if(!e)return;let m=()=>{};m=(()=>{const f=l.push,L=l.replace,F=l.go;return l.push=(a,...k)=>{if(x)return f.apply(l,[a,...k]);const P=typeof a=="string"?a:a.pathname;if(v(p.pathname,P))return f.apply(l,[a,...k]);const I=typeof a=="string"?{pathname:h(a)}:{...a,pathname:h(a.pathname)};w(I),d(!0)},l.replace=(a,...k)=>{if(x)return L.apply(l,[a,...k]);const P=typeof a=="string"?a:a.pathname;if(v(p.pathname,P))return L.apply(l,[a,...k]);const I=typeof a=="string"?{pathname:h(a)}:{...a,pathname:h(a.pathname)};w(I),d(!0)},l.go=a=>{if(x)return F.apply(l,[a]);w(p),d(!0)},()=>{l.push=f,l.replace=L,l.go=F}})();const c=f=>{if(e)return f.preventDefault(),f.returnValue="",""};return window.addEventListener("beforeunload",c),()=>{m(),window.removeEventListener("beforeunload",c)}},[e,l,p,x,h,v]),[g,E,y]}const ne=o.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,ue=({isOpen:e,onConfirm:n,onCancel:p})=>{if(i.useEffect(()=>{const d=u=>{u.key==="Escape"&&p()};return e&&(document.addEventListener("keydown",d),document.body.style.overflow="hidden"),()=>{document.removeEventListener("keydown",d),document.body.style.overflow="unset"}},[e,p]),!e)return null;const l=()=>{n()},g=d=>{d.stopPropagation(),p()};return t.jsx(ne,{onClick:g,children:t.jsxs(re,{onClick:d=>d.stopPropagation(),children:[t.jsxs(ae,{children:[t.jsx(ie,{children:"Незбережені зміни"}),t.jsx(se,{children:"У вас є незбережені зміни. Якщо ви залишите цю сторінку, всі зміни будуть втрачені."})]}),t.jsxs(le,{children:[t.jsx(de,{onClick:l,children:"Залишити сторінку"}),t.jsx(ce,{onClick:g,children:"Продовжити роботу"})]})]})})},j={mobile:"320px",tablet:"768px",desktop:"1024px"},pe=o.form`
  padding: 10px;
  display: flex;
  justify-content: center;
  width: 100%;
