import{d as r,b as x,r as a,a as h,m as b,aw as f,y as $,aA as w,j as o,aB as k}from"./index-634897fe.js";import{H as j}from"./HeaderForUnlogged-cecd09fd.js";const v=r.div`
  display: flex;
  align-items: center;
...
`,D=r.p`
  ...
  margin-bottom: 2rem;
  line-height: 1.5;
`,A=()=>{const e=x(),[l,n]=a.useState(""),{error:i,successMessage:s,isLoading:c}=h(t=>t.auth),g=b();a.useEffect(()=>{i&&e(f())},[e]),a.useEffect(()=>{s&&($.success(s),e(w()))},[s]),a.useEffect(()=>{const t=localStorage.getItem("forgotEmailFormData")||"";t&&n(t)},[]);const p=t=>{const{name:d,value:m}=t.target;localStorage.setItem("forgotEmailFormData",m),n(m)},u=async t=>{t.preventDefault(),localStorage.removeItem("forgotEmailFormData");try{await e(k(l)).unwrap(),n("")}catch(d){console.error("Помилка при відправці запиту:",d)}};return o.jsxs(o.Fragment,{children:[o.jsx(j,{}),o.jsx(v,{children:o.jsxs(y,{children:[o.jsx(B,{children:"Відновлення паролю"}),o.jsx(D,{children:"Після надсилання форми - на вашу електронну пошту прийде посилання для створення нового паролю"}),o.jsxs(G,{onSubmit:u,children:[o.jsxs(E,{children:[o.jsx(C,{htmlFor:"email",children:"Email"}),o.jsx(F,{id:"email",name:"email",type:"email",value:l,onChange:p,placeholder:"Введіть ваш email",required:!0}),i&&o.jsx(z,{children:i})]}),o.jsx(I,{type:"submit",disabled:c,children:c?"Завантаження...":"Відправити"}),o.jsx(S,{type:"button",onClick:()=>g(-1),children:"Назад"})]})]})})]})};export{A as default};
