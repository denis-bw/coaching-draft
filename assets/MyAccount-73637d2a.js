import{d as r,u as Q,a as ee,r as s,j as t,p as te,i as oe,b as L,y as m}from"./index-cec7cca9.js";import{S as re,a as ne,u as ae,N as ie}from"./minus-e2bf1d06.js";import{S as se}from"./DeleteIcon-3f31b818.js";import{C as le}from"./CustomDatePicker-97eda630.js";const l={mobile:"320px",tablet:"768px",desktop:"1024px"},de=r(se)`
...
`,xe=r.label`
  ...
  &:hover {
    ...
    box-shadow: 0 0 0 3px ${({theme:e})=>e.lightGreen}, 0 2px 8px rgba(0, 0, 0, 0.2);
...
`,Pe=({isOpen:e,onConfirm:a,onCancel:h})=>{if(!e)return null;const f=c=>{c.key==="Escape"&&h(),c.key==="Enter"&&a()},d=c=>{c.target===c.currentTarget&&h()};return t.jsx(Ce,{onClick:d,onKeyDown:f,tabIndex:-1,children:t.jsxs(Be,{onClick:c=>c.stopPropagation(),children:[t.jsx(Ie,{children:"Видалити фото профілю?"}),t.jsx(De,{children:"Ви впевнені, що хочете видалити поточне фото профілю? Цю дію не можна буде скасувати."}),t.jsxs(Ge,{children:[t.jsx(Fe,{onClick:a,children:"Видалити"}),t.jsx(Ee,{onClick:h,children:"Скасувати"})]})]})})},Ue=()=>{const e=()=>{},{user:a,isLoading:h}=Q(o=>o.auth),f=ee(),[d,c]=s.useState(a.username||""),[g,z]=s.useState(a.location||""),[x,I]=s.useState(a.dateOfBirth||""),[R,b]=s.useState(!1),[u,C]=s.useState(a.avatar||null),[K,N]=s.useState(!0),[A,D]=s.useState(!1),[T,w]=s.useState(!1),[p,k]=s.useState(null),[W,_,Y]=ae(R),H=5*1024*1024,V=["image/jpeg","image/jpg","image/png","image/webp"],G=o=>o?V.includes(o.type)?o.size>H?(m.error("Розмір файлу не повинен перевищувати 5MB",{position:"top-right",autoClose:3e3}),null):o:(m.error("Дозволені лише зображення (jpeg, jpg, png, webp)",{position:"top-right",autoClose:3e3}),null):null,X=o=>{if(o.key==="Enter"||o.key===" "){const n=document.getElementById("photo-upload");n&&n.click()}},E=o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),p?F():w(!0))},Z=o=>{const n=o.target.files[0];if(n){if(!G(n)){o.target.value="";return}const $=URL.createObjectURL(n);C($),k(n),b(!0)}},F=()=>{u&&u!==a.avatar&&URL.revokeObjectURL(u),C(a.avatar||null),k(null);const o=document.getElementById("photo-upload");o&&(o.value="");const n=d!==(a.username||"")||g!==(a.location||"")||x!==(a.dateOfBirth||"");b(n)},q=async()=>{try{const o=new FormData;o.append("deleteAvatar","true");const n=await f(L(o));if(n.error)throw new Error(n.error);{C(null),k(null);const i=document.getElementById("photo-upload");i&&(i.value=""),m.success("Фото успішно видалено!"),w(!1)}}catch{m.error("Помилка при видаленні фото",{position:"top-right",autoClose:3e3})}};s.useEffect(()=>{},[e]),s.useEffect(()=>{const o=d!==(a.username||"")||g!==(a.location||"")||x!==(a.dateOfBirth||"")||p!==null;b(o)},[d,g,x,a,p]),s.useEffect(()=>()=>{u&&u!==a.avatar&&URL.revokeObjectURL(u)},[u,a.avatar]);const P=o=>{const{name:n,value:i}=o.target;n==="username"&&(c(i),N(i.length>=3)),n==="location"&&z(i),n==="birthdate"&&I(i)},J=async o=>{o.preventDefault();const n=new FormData;if(d!==a.username&&n.append("username",d||""),g!==a.location&&n.append("location",g||""),x!==a.dateOfBirth&&n.append("dateOfBirth",x||null),p){const i=G(p);if(!i)return;n.append("avatar",i)}if(n.has("username")||n.has("location")||n.has("dateOfBirth")||n.has("avatar"))try{const i=await f(L(n));if(i.error)throw new Error(i.error);{b(!1),k(null),m.success("Зміни успішно збережено!");const $=document.getElementById("photo-upload");$&&($.value="")}}catch{m.error("Помилка при збереженні даних",{position:"top-right",autoClose:3e3})}else m.info("Немає змін для збереження.",{position:"top-right",autoClose:3e3})},S=a.avatar&&!p,M=p!==null;return t.jsxs(t.Fragment,{children:[t.jsx(ie,{isOpen:W,onConfirm:_,onCancel:Y}),t.jsx(Pe,{isOpen:T,onConfirm:q,onCancel:()=>w(!1)}),t.jsx(ce,{onSubmit:J,children:t.jsxs(he,{children:[t.jsx(ue,{children:t.jsxs(pe,{children:[t.jsx(me,{children:t.jsx(ge,{src:u||te,alt:"Фото профілю",loading:"lazy",onError:o=>{o.target.onerror=null,o.target.src=oe}})}),t.jsx(xe,{htmlFor:"photo-upload",tabIndex:0,onKeyDown:X,children:t.jsx($e,{})}),(S||M)&&t.jsxs(fe,{children:[S&&t.jsx(be,{type:"button",tabIndex:0,onKeyDown:E,onClick:()=>w(!0),title:"Видалити фото",children:t.jsx(de,{})}),M&&t.jsx(we,{type:"button",tabIndex:0,onKeyDown:E,onClick:F,title:"Скасувати завантаження",children:t.jsx(ke,{})})]}),t.jsx(ye,{id:"photo-upload",type:"file",accept:"image/jpeg,image/jpg,image/png,image/webp",onChange:Z})]})}),t.jsxs(O,{children:[t.jsx(y,{children:t.jsxs(v,{children:[t.jsx(j,{htmlFor:"username",children:"Ім'я користувача"}),t.jsx(B,{id:"username",name:"username",placeholder:"Введіть ім'я користувача",value:d,maxLength:25,minLength:3,onChange:P,onFocus:()=>D(!0),onBlur:()=>D(!1),$isEmpty:!A&&d===""})]})}),t.jsx(y,{children:t.jsxs(v,{children:[t.jsx(j,{htmlFor:"email",children:"Електронна пошта"}),t.jsx(B,{id:"email",type:"email",value:a.email||"email",disabled:!0})]})})]}),t.jsxs(O,{children:[t.jsx(y,{children:t.jsxs(v,{children:[t.jsx(j,{htmlFor:"birthdate",children:"Дата народження"}),t.jsx(le,{selectedDate:x,onDateChange:I})]})}),t.jsx(y,{children:t.jsxs(v,{children:[t.jsx(j,{htmlFor:"location",children:"Локація"}),t.jsx(B,{id:"location",name:"location",placeholder:"Введіть вашу локацію",value:g,maxLength:50,onChange:P})]})})]}),t.jsx(je,{children:t.jsx(ve,{type:"submit",disabled:h||!K,children:h?"Збереження...":"Зберегти зміни"})})]})})]})};export{Ue as default};
